---
title: Memory Intelligence SDK
sidebar_label: Memory Intelligence SDK
...
For baseline memory CRUD in browser, edge, or universal TypeScript apps, prefer [`@lanonasis/memory-client`](./typescript.md).

## Related

- [SDK Capability Matrix](./matrix.md)
- [TypeScript SDK overview](./typescript.md)
